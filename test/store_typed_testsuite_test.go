...
func (s *StoreTestSuite) TestBasicWorkflowTyped(t *testing.T) {
	...
	err := lymbo.HandleFunc("test-task", func(ctx context.Context, t *lymbo.Ticket) error {
		if processed.Load() {
			return nil
		}
		processedTicket = t
...
func (s *StoreTestSuite) TestExponentialBackoffStrategyTyped(t *testing.T) {
	...
	err := lymbo.HandleFunc("backoff-task", func(ctx context.Context, t *lymbo.Ticket) error {
		mu.Lock()
...
func (s *StoreTestSuite) TestRetryWithFixedDelayTyped(t *testing.T) {
	...
	err := lymbo.HandleFunc("retry-task", func(ctx context.Context, t *lymbo.Ticket) error {
		mu.Lock()
...
func (s *StoreTestSuite) TestDoneKeepsTicketTyped(t *testing.T) {
	...
	err := lymbo.HandleFunc("done-task", func(ctx context.Context, t *lymbo.Ticket) error {
		if processed.Load() {
			return nil
		}
		processed.Store(true)
...
func (s *StoreTestSuite) TestFailWithErrorReasonTyped(t *testing.T) {
	...
	err := lymbo.HandleFunc("fail-task", func(ctx context.Context, t *lymbo.Ticket) error {
		if processed.Load() {
			return nil
		}
		processed.Store(true)
...
func (s *StoreTestSuite) TestCancelRemovesTicketTyped(t *testing.T) {
	...
	err := lymbo.HandleFunc("cancel-task", func(ctx context.Context, t *lymbo.Ticket) error {
		if processed.Load() {
			return nil
		}
		processed.Store(true)
...
func (s *StoreTestSuite) TestPriorityOrderingTyped(t *testing.T) {
	...
	err := lymbo.HandleFunc("priority-task", func(ctx context.Context, t *lymbo.Ticket) error {
...
func (s *StoreTestSuite) TestMultipleTicketsParallelProcessingTyped(t *testing.T) {
	...
	err := lymbo.HandleFunc("parallel-task", func(ctx context.Context, ticket *lymbo.Ticket) error {
...
func (s *StoreTestSuite) TestExponentialBackoffMaxDelayTyped(t *testing.T) {
	...
	err := lymbo.HandleFunc("maxdelay-task", func(ctx context.Context, t *lymbo.Ticket) error {
		mu.Lock()
		processTimes = append(processTimes, time.Now())
		mu.Unlock()
